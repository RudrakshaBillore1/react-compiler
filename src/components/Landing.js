...
const Landing = () => {
  ...
  return (
    <>
      ...
      <a
        href="https://github.com/RudrakshaBillore1/"
      ...
      <div className="flex flex-row space-x-4 items-start px-4 py-4 wd">
        ...
        <div className="right-container flex flex-shrink-0 w-[30%] flex-col ow">
          ...
          <div className="flex flex-col items-end">
            ...
            <button
              ...
              className={classnames(
                "mt-4 border-2 border-black z-10 rounded-md shadow-[5px_5px_0px_0px_rgba(0,0,0)] px-4 py-2 hover:shadow transition duration-200 bg-white flex-shrink-0  bn",
                !code ? "opacity-50" : ""
              )}
            >
